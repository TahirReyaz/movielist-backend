...
export const isOwner = async (req, res, next) => {
    try {
        ...
        const currentUserId = lodash.get(req, "identity._id");
...
export const isOwnList = async (req, res, next) => {
    try {
...
export const isOwnEntry = async (req, res, next) => {
    try {
...
export const isEntryCreater = async (req, res, next) => {
    try {
